...
// Copyright (c) 2018 The CrocodileCash developers
...
static const unsigned int MAX_BLOCK_SIZE = 750000;
...
static const int STAKE_MAX_AGE = -1; // (unlimited) stake age of full weight
